...
![img](./assets/Git-push-command.jpeg)
...
![img](./assets/299CF000-7B6E-4BEC-B8C2-D9AEB053307B.jpg)
...
![img](./assets/C5A6670F-202D-4F2C-8A63-07CEA37BB67A.jpg)
...
## 第十二节 Sourcetree 使用教程

![img](./assets/Sourcetree@2x-icon-blue.png)
...
![img](./assets/sourcetree_aa.png)

创建 Bitbucket 账户可跳过初始设置，加载 SSH 密钥，如果有会默认加载进来，也可以后面再设置。

![img](./assets/sourcetree_account.png)
...
![img](./assets/sourcetree-2.jpeg)

接下来我们通过添加账户按钮添加 Github 账户。

![img](./assets/sourcetree-3.jpeg)

Github 账户添加完成后，就可以直接克隆我们自己的账户：

![img](./assets/sourcetree-4.jpeg)

也可以克隆其他远程仓库：

![img](./assets/sourcetree-5.jpeg)

克隆完成后，我们就可以进行提交、拉取、合并等操作：

![img](./assets/sourcetree-6.jpeg)
...
![img](./assets/sourcetree-7.jpeg)

输入您的目标路径和存储库名称，然后点击**创建**。

![img](./assets/sourcetree-8.jpeg)

创建完成后就会显示在本地的列表中：

![img](./assets/sourcetree-9.jpeg)

如果我们本地已经存在一个仓库，可以直接添加它。

点击**新建**，然后 点击**添加已经存在的本地仓库**：

![img](./assets/sourcetree-10.jpeg)
